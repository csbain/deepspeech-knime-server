...
class AudioUtils:
    ...
    def __init__(self, file_bytes, file_ext):
        self.vad = webrtcvad.Vad()
        self.main_temp_audio_file = util.generate_temp_filename(file_ext)
        self.wip_temp_audio_file = util.generate_temp_filename("wav")
    ...
    def generate_noise_profile(self, seconds_start=0, seconds_finish=0.5):
        tfm = sox.Transformer()
        wip_profile_file = util.generate_temp_filename()
